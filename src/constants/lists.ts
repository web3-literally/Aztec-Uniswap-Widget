...
export const OFFICIAL_LIST = 'https://raw.githubusercontent.com/DramaCrypto/official-tokens/main/token-list.json'
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [OFFICIAL_LIST]
